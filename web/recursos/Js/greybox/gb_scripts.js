...
GreyBox=new AJS.Class({
    init:function(c){
        ...
        this.src_loader=this.root_dir+"../recursos/Js/greybox/loader_frame.html";
...
setOverlayDimension:function(){
    ...
    if(a<AJS.getScrollTop()){
        ...
        AJS.setHeight(
            this.overlay,AJS.getScrollTop()+b.h)
        }
    },
...
initFrame:function(){
    if(!this.iframe){
        ...
        AJS.ACN(this.g_window,this.top_cnt,
            this.middle_cnt,this.bottom_cnt)
        }
    },
onHide:function(){},
onShow:function(){},
...
AJS.preloadImages(GB_ROOT_DIR+"../recursos/Js/greybox/indicator.gif");
script_loaded=true;
var GB_SETS={};
...
GB_Gallery=GreyBox.extend({
    init:function(a){
        this.parent({});
        this.img_close=this.root_dir+"../recursos/Js/greybox/g_close.gif";
        AJS.update(this,a);
...
AJS.preloadImages(GB_ROOT_DIR+"../recursos/Js/greybox/g_close.gif");
...
GB_Sets=GB_Gallery.extend({
    init:function(a,b){
        this.parent(a);
        if(!this.img_next){
            this.img_next=this.root_dir+"../recursos/Js/greybox/next.gif"
            }
            if(!this.img_prev){
            this.img_prev=this.root_dir+"../recursos/Js/greybox/prev.gif"
            }
            this.current_set=b
        },
    showSet:function(a){
...
AJS.AEV(window,"load",function(){
    AJS.preloadImages(GB_ROOT_DIR+"../recursos/Js/greybox/next.gif",GB_ROOT_DIR+"../recursos/Js/greybox/prev.gif")
    });
...
GB_Window=GreyBox.extend({
    init:function(a){
        this.parent({});
        this.img_header=this.root_dir+"../recursos/Js/greybox/header_bg.gif";
        this.img_close=this.root_dir+"../recursos/Js/greybox/w_close.gif";
...
AJS.preloadImages(GB_ROOT_DIR+"../recursos/Js/greybox/w_close.gif",GB_ROOT_DIR+"../recursos/Js/greybox/header_bg.gif");
script_loaded=true;