        ...
        <div id="container" style="margin-left: 5px; margin-right: 5px">
            ...
            <div id="demo">
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%" style="text-align: center">
                    <thead >
                        <tr><td class="columna1">No.</td><td class="columna2">Id</td><td class="columna3">Nombre Proyecto</td><td class="columna4">Integrantes</td><td class="columna5">Asesor</td></tr>
                    </thead>
                    <tbody>
                        <%
                            String sql = "select proyecto.idproyecto, proyecto.tituloproyecto from proyecto, usuarioevaluador where usuarioevaluador.idusuario='" + idDocente + "';";
