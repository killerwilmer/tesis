...
<html>
    <head>
        ...
        <title>Guardando Asesorias</title>
    </head>
    <body>
        <h1>Guardando Asesorias</h1>
    </body>
</html>
<%
    ...
    if (!editor.equals("")) {
        try {
            ...
            String SqlInsert = "insert into asesoria (idproyecto,idusuario,fechaasesoria,temaasesoria) values ("+idProyecto+","+idDocente+",'"+miFecha+"','"+editor+"');";
