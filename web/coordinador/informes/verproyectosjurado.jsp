...
<%            } else {
        ...
        idproyecto = Integer.parseInt(request.getParameter("rowI"));
    }
%>
<html>
    <head>
        ...
        <script>
            $(document).ready(function() {
                $(".volverproyectodoc").click(function(event) {
    ...
    <body>
        <img class="volverproyectodoc" src='../recursos/Imagenes/Coordinador/volver.png' alt=''/>
        <div id="container" style="margin-left: 20px; margin-right: 20px">
            <h1 style="text-align: center; margin-top: -40px;">LISTA PROYECTOS COMO JURADO</h1>
            <div id="demo">
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
                    ...
                    <tbody>
                       <%                            
                        String sql ="select proyecto.idproyecto, proyecto.tituloproyecto, etapa.nombreetapa from proyecto, usuarioevaluador, etapa where usuarioevaluador.idproyecto=proyecto.idproyecto and proyecto.etapaproyecto=etapa.idetapa and usuarioevaluador.idusuario='" + idproyecto + "';";
