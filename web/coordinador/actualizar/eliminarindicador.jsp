<%-- 
    Document   : eliminarindicador
    Created on : 21/11/2012, 08:15:00 AM
    Author     : Alex
--%>
...
<html>
    ...
    <body>
        <%
            int numero = Integer.parseInt(request.getParameter("ideliminarindi"));
            String consultas = "delete from indicador where idindicador = '" + numero + "'";
