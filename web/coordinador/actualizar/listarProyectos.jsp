        ...
        <script>
           ...
           $(document).ready(function() {
                $('#example tbody tr a.deletes img').live( 'click', function (e) {
                    var rowIDPRO = $(this).parent().attr('id');
                    $("#wraper").load('actualizar/formularioProyecto.jsp?rowIDPRO=' + rowIDPRO);
                });
                
                $('#example tbody tr a.deletess img').live( 'click', function (e) {
                    var rowIDPR = $(this).parent().attr('id');
                    $("#wraper").load('actualizar/formularioActores.jsp?rowIDPR=' + rowIDPR);
                });
            } );
        </script>
    </head>
