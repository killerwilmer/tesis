...
<%
    ...
    try {
        String sql = "select nombres, apellidos, idusuario, idtipousuario from usuario where (lower(nombres) LIKE '%" + str.toLowerCase() + "%' or lower(apellidos) LIKE '%" + str.toLowerCase() + "%') LIMIT 10";
